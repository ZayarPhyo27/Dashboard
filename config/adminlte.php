        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'can' => 'permission-list',
                    'url'  => '/permission',
                    'active' => ['permission', 'permission*', 'regex:@^permission/[0-9]+$@']
                ],
            ],
        ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'can' => 'article-list',
                    'url'  => '/article',
                    'active' => ['article', 'article*', 'regex:@^article/[0-9]+$@']
                ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'can' => 'quiz-list',
                    'url'  => '/quiz',
                    'active' => ['quiz', 'quiz*', 'regex:@^quiz/[0-9]+$@']
                ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'can' => 'notification',
                    'url'  => '/notification',
                    'active' => ['notification', 'notification*', 'regex:@^notification/[0-9]+$@']
                ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'can' => 'video-list',
                    'url'  => '/video',
                    'active' => ['video', 'video*', 'regex:@^video/[0-9]+$@']
                ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'can' => 'podcast-list',
                    'url' => '/podcast',
                    'active' => ['podcast', 'podcast*', 'regex:@^podcast/[0-9]+$@']
                ],
            ],
        ],
        [
            'text' => 'Comic Management',
            ...
            'submenu' => [
                [
                    ...
                    'can' => 'comic-list',
                    'url' => '/comic',
                    'active' => ['comic', 'comic*', 'regex:@^comic/[0-9]+$@']
                ],
            ],
        ],
        [
